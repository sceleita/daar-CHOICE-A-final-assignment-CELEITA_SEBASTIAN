...
function parseBookFile (filePath) {
  ...
  return { title, author, language, paragraphs }
}

/** Bulk index the book data in ElasticSearch */
async function insertBookData (title, author, language, paragraphs) {
...
async function readAndInsertBooks () {
  ...
  try {
    ...
    for (let file of files) {
      ...
      const { title, author, language, paragraphs } = parseBookFile(filePath)
      await insertBookData(title, author, language, paragraphs)
    }
  } catch (err) {
    console.error(err)
  }
